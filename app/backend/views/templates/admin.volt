...
<html lang="en">
    ...
    <body>
        {% set session = this.session.get('phalcon-session') %}
        <div id="wrapper">
            <!-- Navigation -->
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <ul class="nav navbar-right top-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="divider"></li>
                            <li>
                                <a href="{{ url("/deconnexion") }}"><i class="fa fa-fw fa-power-off"></i> Déconnexion</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                            <a href="{{ url("/admin/categorie/gestion") }}"><i class="fa fa-fw fa-list"></i>Catégories</a>
                        </li>
                        <li>
                            ...
                            <ul id="musique" class="collapse">
                                <li>
                                    <a href="{{ url("/admin/musique/ajout") }}">Ajouter</a>
                                </li>
                                <li>
                                    <a href="{{ url("/admin/musique/gestion") }}">Gestion des musiques</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{ url("/admin/utilisateur/gestion") }}"><i class="fa fa-fw fa-edit"></i> Utilisateurs</a>
                        </li>
                        <li>
