...
{% block content %}
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form class="form" action="{{ url("/admin/categorie/gestion") }}" method="post">
                <div class="row">
                    <div class="col-lg-5">
                ...
                <tbody>
                    {% for categorie in categories %}
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary" href="{{url("/admin/categorie/modification/"~ categorie.id)}}" role="button">Modifier</a>
                                <a class="btn btn-danger" href="{{url("/admin/categorie/suppression/"~ categorie.id)}}" role="button">Supprimer</a>
                            </td>
                        </tr>
                    {% endfor %}
                </tbody>
