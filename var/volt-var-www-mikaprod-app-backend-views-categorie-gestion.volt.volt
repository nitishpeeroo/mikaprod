...
<html lang="en">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form class="form" action="<?= $this->url->get('/admin/categorie/gestion') ?>" method="post">
                <div class="row">
                    <div class="col-lg-5">
                ...
                <tbody>
                    <?php foreach ($categories as $categorie) { ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary" href="<?= $this->url->get('/admin/categorie/modification/' . $categorie->id) ?>" role="button">Modifier</a>
                                <a class="btn btn-danger" href="<?= $this->url->get('/admin/categorie/suppression/' . $categorie->id) ?>" role="button">Supprimer</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
