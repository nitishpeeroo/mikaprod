...
<html lang="en">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form class="form" action="<?= $this->url->get('/admin/utilisateur/gestion/') ?>" method="post">
                <div class="row">
                    <div class="col-lg-4">
                ...
                <tbody>
                    <?php foreach ($utilisateurs as $utilisateur) { ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary" href="<?= $this->url->get('/admin/utilisateur/mot-de-passe-oublier/' . $utilisateur->id) ?>" role="button">Régénérer mot de passe</a>
                                <a class="btn btn-primary" href="<?= $this->url->get('/admin/utilisateur/modification/' . $utilisateur->id) ?>" role="button">Modifier</a>
                                <a class="btn btn-danger" href="<?= $this->url->get('/admin/utilisateur/suppression/' . $utilisateur->id) ?>" role="button">Supprimer</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
