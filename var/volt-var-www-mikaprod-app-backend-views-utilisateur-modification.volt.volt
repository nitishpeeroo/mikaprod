...
<html lang="en">
    ...
    <div class="row">
        <div class="col-lg-10">
            <h1 class="page-header">
                <a  class="btn btn-primary" href="<?= $this->url->get('/admin/utilisateur/gestion') ?>" role="button" >Retour</a>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form class="form" action="<?= $this->url->get('/admin/utilisateur/modification/' . $utilisateur->id) ?>" method="post">
